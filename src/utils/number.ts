...
export function formatCurrency(amount: BigNumber.Value, decimals: number) {
...
export function fromDust(val: BigNumber | bigint | number | string, decimal: number | bigint): BigNumber {
...
export function fromDustToPrecision(val: BigNumber | bigint | number | string, decimal: number | bigint): string {
...
export function toBigNumber(val?: BigNumber | bigint | number | string | BigNumber.Instance): BigNumber {
